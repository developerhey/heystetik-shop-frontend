...
ENV VITE_GOOGLE_OAUTH_CLIENT_ID=714578753540-1agk186m4da4uqgeebe0cprkoc8r79st.apps.googleusercontent.com
ENV GOOGLE_OAUTH_CLIENT_SECRET=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
ENV VITE_FACEBOOK_APP_ID=840389841155170
ENV VITE_GOOGLE_MAP_API_KEY=AIzaSyCF5fKaL91ofgj1uusPnnPJEIzA3l7DnmE
ENV PORT=5173
EXPOSE 5173
CMD ["npm", "run", "start"]